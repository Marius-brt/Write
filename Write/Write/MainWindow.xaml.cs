...
namespace Write
{
	public partial class MainWindow : Window
	{
		...
		public MainWindow(){InitializeComponent(); this.FontComboBox.SelectionChanged += new SelectionChangedEventHandler(FontComboBoxChanged);
		...
		private void MinimizeBnt_MouseEnter(object sender, MouseEventArgs e){MinimizeBnt.Background=new SolidColorBrush(Color.FromArgb(60, 255, 255, 255));}
		private void MinimizeBnt_MouseLeave(object sender, MouseEventArgs e){MinimizeBnt.Background=new SolidColorBrush(Color.FromArgb(0, 255, 255, 255));}
		private void MinimizeBnt_MouseDown(object sender, MouseButtonEventArgs e){this.WindowState=WindowState.Minimized;}
		private void RestoreBnt_MouseEnter(object sender, MouseEventArgs e){RestoreBnt.Background=new SolidColorBrush(Color.FromArgb(60, 255, 255, 255));}
		private void RestoreBnt_MouseLeave(object sender, MouseEventArgs e) { RestoreBnt.Background=new SolidColorBrush(Color.FromArgb(0, 255, 255, 255));}
		private void RestoreBnt_MouseDown(object sender, MouseButtonEventArgs e){this.WindowState=WindowState.Normal;}
		private void CloseBnt_MouseEnter(object sender, MouseEventArgs e){CloseBnt.Background=new SolidColorBrush(Color.FromArgb(60, 255, 255, 255));}
		private void CloseBnt_MouseLeave(object sender, MouseEventArgs e){CloseBnt.Background=new SolidColorBrush(Color.FromArgb(0, 255, 255, 255));}
		private void CloseBnt_MouseDown(object sender, MouseButtonEventArgs e)
		{
			Close();
		}
		private void MaximizeBnt_MouseEnter(object sender, MouseEventArgs e){MaximizeBnt.Background=new SolidColorBrush(Color.FromArgb(60, 255, 255, 255));}
		private void MaximizeBnt_MouseLeave(object sender, MouseEventArgs e){MaximizeBnt.Background=new SolidColorBrush(Color.FromArgb(0, 255, 255, 255));}
		private void MaximizeBnt_MouseDown(object sender, MouseButtonEventArgs e){this.WindowState=WindowState.Maximized;}		
		private void Rectangle_MouseDown(object sender, MouseButtonEventArgs e){this.DragMove();}
		private void Window_SizeChanged(object sender, SizeChangedEventArgs e){if(this.WindowState==WindowState.Maximized){RestoreBnt.Visibility=Visibility.Visible;MaximizeBnt.Visibility=Visibility.Collapsed;}
		if(this.WindowState==WindowState.Normal){RestoreBnt.Visibility=Visibility.Collapsed;MaximizeBnt.Visibility=Visibility.Visible;}}
		private void MIClose_Click(object sender, RoutedEventArgs e)
		{
			Close();
		}
		private void LeftBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(Block.TextAlignmentProperty, "Left");}
		private void CenterBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(Block.TextAlignmentProperty, "Center");}
		private void RightBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(Block.TextAlignmentProperty, "Right");}
		private void JustifyBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(Block.TextAlignmentProperty, "Justify");}
		private void BoldBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(TextElement.FontWeightProperty, "Bold");}
		private void BoldBnt_Unselected(object sender, RoutedEventArgs e){ChangeTextProperty(TextElement.FontWeightProperty, "Normal");}
		private void ItalicBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(FontStyleProperty, "Italic");}
		private void ItalicBnt_Unselected(object sender, RoutedEventArgs e){ChangeTextProperty(FontStyleProperty, "Normal");}
		private void UnderlineBnt_Selected(object sender, RoutedEventArgs e){ChangeTextProperty(Inline.TextDecorationsProperty, "Underline");}
		...
		ts.ApplyPropertyValue(Inline.TextDecorationsProperty, textDecorations);}TextZone.Focus();}
		...
		private void SaveCommand_Executed(object sender, ExecutedRoutedEventArgs e){Save();}
		private void SaveAsCommand_Executed(object sender, ExecutedRoutedEventArgs e){SaveAs();}
